...
namespace ElectoralApp.DAL
{
    ...
    public partial class ElectoralDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<Admin_GetDropDownData_Result> Admin_GetDropDownData(Nullable<long> userId, string dropDownType, Nullable<int> dropDownRefId)
        {
            ...
            var dropDownRefIdParameter = dropDownRefId.HasValue ?
                new ObjectParameter("DropDownRefId", dropDownRefId) :
                new ObjectParameter("DropDownRefId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Admin_GetDropDownData_Result>("Admin_GetDropDownData", userIdParameter, dropDownTypeParameter, dropDownRefIdParameter);
        }
